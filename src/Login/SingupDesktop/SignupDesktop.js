  ...
  render() {
    ...
    return (
      <div className="signup_mb">
        ...
        <div className="signup-form signup_form_dtp">
          ...
          {this.props.signupRes.result === "error" ? (
            <div className="text-center color_red">
...
const mapStateToProps = state => {
  return {
    ...
    passwordMismatchState: state.fetchAuthReducer.passwordMismatch
  };
};
...
const SignupDesktopComp = connect(
  mapStateToProps,
  mapDispatchToProps
)(SignupDesktop);

export default SignupDesktopComp;
